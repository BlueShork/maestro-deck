// RubberSegment from React Bits (https://www.reactbits.dev/micro/rubber-segment),
// copied from its shadcn registry item RubberSegment-TS-TW, unmodified apart
// from formatting and a comment in one empty catch (no-empty). Upstream: https://github.com/DavidHDev/react-bits
