// Vendored from React Bits (https://www.reactbits.dev/micro/swipe-toast), TS-CSS variant.
// Only change: Hugeicons close icon swapped for lucide's X.
...
const SwipeToast: React.FC<SwipeToastProps> = ({
  ...
  const onPointerDown = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    try {
      ...
      // pointer already released or never captured
    }
    y.stop();
    drag.current = {
      id: e.pointerId,
