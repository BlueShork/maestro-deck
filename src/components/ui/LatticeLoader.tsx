// LatticeLoader from React Bits (https://www.reactbits.dev/micro/lattice-loader),
// copied from its shadcn registry item LatticeLoader-TS-TW, unmodified apart
// from formatting. Upstream: https://github.com/DavidHDev/react-bits
